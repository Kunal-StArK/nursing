...
ALLOWED_HOSTS = ['nursing-1-1nfn.onrender.com', '127.0.0.1', 'localhost']
...
EMAIL_PORT = 587  # Casts the port string to an integer
EMAIL_HOST_USER = 'otaswelifar@gmail.com'
